...
export const payChannel = ({ key = 'paymentBankId', watch = 'spId', fields, ...others }: DynamicOptions = {}) => ({
	label: '支付通道',
	control: 'el-select',
	key,
	// mapping correctly
...
export const underTakers = ({ key = 'undertakerId', watch = 'spId', fields, ...others }: DynamicOptions = {}) => ({
	label: '签约承接人',
	control: 'el-select',
	key,
	props: {
