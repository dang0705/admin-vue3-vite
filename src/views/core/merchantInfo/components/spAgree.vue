<template>
	...
	<el-row>
		<div class="mb8" style="width: 100%">
			<el-button icon="folder-add" type="primary" class="ml10" @click="openMerchantForm('add')" v-auth="'core_merchantInfo_add'"> 新 增 </el-button>
			<right-toolbar
	...
	>
		<el-table-column prop="merchantName" min-width="100" label="xxx" show-overflow-tooltip />
		<el-table-column prop="socialCreditCode" min-width="140" label="xxx" show-overflow-tooltip />
		<el-table-column prop="spList" label="xxx" show-overflow-tooltip />
		<el-table-column prop="contactName" label="xxx" show-overflow-tooltip />
		<el-table-column prop="contactPhone" label="要求上传任务成果" show-overflow-tooltip />
		<el-table-column prop="createBy" label="起始时间" show-overflow-tooltip />
		<el-table-column prop="createTime" label="终止时间" show-overflow-tooltip />
		<el-table-column prop="status" label="协议状态" show-overflow-tooltip>
