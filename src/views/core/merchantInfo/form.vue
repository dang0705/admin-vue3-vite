    ...
    <el-col :span="12" class="mb20">
      <el-form-item label="企业性质(1:私营企业，2：国有企业)" prop="enterpriseType">
            <el-radio-group v-model="form.enterpriseType">
             <el-radio :label="item.value" v-for="(item, index) in enterprise_type" border :key="index">{{ item.label }}
            </el-radio>
            </el-radio-group>
        </el-form-item>
      </el-col>
    ...
    <el-col :span="12" class="mb20">
      <el-form-item label="企业规模" prop="enterpriseScale">
            <el-radio-group v-model="form.enterpriseScale">
             <el-radio :label="item.value" v-for="(item, index) in enterprise_scale" border :key="index">{{ item.label }}
            </el-radio>
            </el-radio-group>
        </el-form-item>
      </el-col>
    ...
    <el-col :span="12" class="mb20">
      <el-form-item label="纳税人类型(1:小规模纳税人，2：一般纳税人)" prop="taxType">
            <el-radio-group v-model="form.taxType">
             <el-radio :label="item.value" v-for="(item, index) in tax_type" border :key="index">{{ item.label }}
            </el-radio>
            </el-radio-group>
        </el-form-item>
      </el-col>
    ...
    <el-col :span="12" class="mb20">
      <el-form-item label="状态" prop="status">
            <el-radio-group v-model="form.status">
             <el-radio :label="item.value" v-for="(item, index) in merchant_status" border :key="index">{{ item.label }}
            </el-radio>
            </el-radio-group>
        </el-form-item>
      </el-col>
