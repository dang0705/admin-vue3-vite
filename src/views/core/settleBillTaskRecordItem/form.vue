<template>
    ...
    <el-col :span="12" class="mb20">
      <el-form-item label="承接人-姓名" prop="undertakerName">
        <el-input v-model="form.undertakerName" placeholder="请输入承接人-姓名"/>
      </el-form-item>
      </el-col>
    ...
    <el-col :span="12" class="mb20">
      <el-form-item label="承接人手机号码" prop="undertakerPhone">
        <el-input v-model="form.undertakerPhone" placeholder="请输入承接人手机号码"/>
      </el-form-item>
      </el-col>

    <el-col :span="12" class="mb20">
      <el-form-item label="承接人开户行" prop="undertakerBankName">
        <el-input v-model="form.undertakerBankName" placeholder="请输入承接人开户行"/>
      </el-form-item>
      </el-col>

    <el-col :span="12" class="mb20">
      <el-form-item label="承接人银行卡号" prop="undertakerBankNumber">
        <el-input v-model="form.undertakerBankNumber" placeholder="请输入承接人银行卡号"/>
      </el-form-item>
      </el-col>
    ...
    <el-col :span="12" class="mb20">
      <el-form-item label="任务金额(元)" prop="taskAmount">
        <el-input v-model="form.taskAmount" placeholder="请输入任务金额(元)"/>
      </el-form-item>
      </el-col>

    <el-col :span="12" class="mb20">
      <el-form-item label="代扣税款(元)" prop="taxWithheld">
        <el-input v-model="form.taxWithheld" placeholder="请输入代扣税款(元)"/>
      </el-form-item>
      </el-col>

    <el-col :span="12" class="mb20">
      <el-form-item label="实发金额(元)" prop="paidAmount">
        <el-input v-model="form.paidAmount" placeholder="请输入实发金额(元)"/>
      </el-form-item>
      </el-col>

    <el-col :span="12" class="mb20">
      <el-form-item label="代发手续费(元)" prop="commissionAmount">
        <el-input v-model="form.commissionAmount" placeholder="请输入代发手续费(元)"/>
      </el-form-item>
      </el-col>

    <el-col :span="12" class="mb20">
      <el-form-item label="承接开始时间" prop="undertaderStartTime">
            <el-date-picker type="datetime" placeholder="请选择承接开始时间" v-model="form.undertaderStartTime" :value-format="dateTimeStr"></el-date-picker>
      </el-form-item>
      </el-col>
    ...
    <el-col :span="12" class="mb20">
      <el-form-item label="承接结束时间" prop="undertaderEndTime">
            <el-date-picker type="datetime" placeholder="请选择承接结束时间" v-model="form.undertaderEndTime" :value-format="dateTimeStr"></el-date-picker>
      </el-form-item>
      </el-col>
