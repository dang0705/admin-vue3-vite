<template>
    ...
    <el-col :span="12" class="mb20">
      <el-form-item label="结算任务名称" prop="taskName">
        <el-input v-model="form.taskName" placeholder="请输入结算任务名称"/>
      </el-form-item>
      </el-col>
    ...
    <el-col :span="12" class="mb20">
      <el-form-item label="支付通道名称" prop="paymentBankName">
        <el-input v-model="form.paymentBankName" placeholder="请输入支付通道名称"/>
      </el-form-item>
      </el-col>
    ...
    <el-col :span="12" class="mb20">
      <el-form-item label="服务协议-名称" prop="serviceContractName">
        <el-input v-model="form.serviceContractName" placeholder="请输入服务协议-名称"/>
      </el-form-item>
      </el-col>
    ...
    <el-col :span="12" class="mb20">
      <el-form-item label="审核状态（10：待审核，20：审核通过，30：审核不通过）" prop="auditStatus">
           ...
           <el-radio label="审核状态（10：待审核，20：审核通过，30：审核不通过）" border>审核状态（10：待审核，20：审核通过，30：审核不通过）</el-radio>
            </el-radio-group>
        </el-form-item>
      </el-col>
    ...
    <el-col :span="12" class="mb20">
      <el-form-item label="账单生成时间" prop="billCreateTime">
            <el-date-picker type="datetime" placeholder="请选择账单生成时间" v-model="form.billCreateTime" :value-format="dateTimeStr"></el-date-picker>
      </el-form-item>
      </el-col>
    ...
    <el-col :span="12" class="mb20">
      <el-form-item label="账单发放时间" prop="billSettleTime">
            <el-date-picker type="datetime" placeholder="请选择账单发放时间" v-model="form.billSettleTime" :value-format="dateTimeStr"></el-date-picker>
      </el-form-item>
      </el-col>
    ...
    <el-col :span="12" class="mb20">
      <el-form-item label="服务费计算方式-描述" prop="feeCalculationMethodDesc">
        <el-input v-model="form.feeCalculationMethodDesc" placeholder="请输入服务费计算方式-描述"/>
      </el-form-item>
      </el-col>

    <el-col :span="12" class="mb20">
      <el-form-item label="服务费计算比例" prop="feeCalculationMethodRate">
        <el-input v-model="form.feeCalculationMethodRate" placeholder="请输入服务费计算比例"/>
      </el-form-item>
      </el-col>

    <el-col :span="12" class="mb20">
      <el-form-item label="任务总金额" prop="taskAmountTotal">
        <el-input v-model="form.taskAmountTotal" placeholder="请输入任务总金额"/>
      </el-form-item>
      </el-col>

    <el-col :span="12" class="mb20">
      <el-form-item label="服务费总金额" prop="serviceAmountTotal">
        <el-input v-model="form.serviceAmountTotal" placeholder="请输入服务费总金额"/>
      </el-form-item>
      </el-col>

    <el-col :span="12" class="mb20">
      <el-form-item label="结算总金额" prop="billAmountTotal">
        <el-input v-model="form.billAmountTotal" placeholder="请输入结算总金额"/>
      </el-form-item>
      </el-col>

    <el-col :span="12" class="mb20">
      <el-form-item label="账单创建人" prop="createBillUser">
        <el-input v-model="form.createBillUser" placeholder="请输入账单创建人"/>
      </el-form-item>
      </el-col>
