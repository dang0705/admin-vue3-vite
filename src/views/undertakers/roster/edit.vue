...
import { addSp, uploadCard, updateMobile } from '/src/api/core/undertakerInfo'
import { rule } from '/@/utils/validate'
import uploadBusinessType from '/@/enums/upload-business-type'
import { getSpInfoListId } from '/src/api/core/undertakerInfo'
...
const onSubmit = async () => {
  ...
  try {
    ...
    form.type === 'addSp'
      ...
      : await uploadCard({
          id: form.id,
          cardFront: form.undertakerPortrait,
          cardOpposite: form.undertakerNationalEmblem
        })
    useMessage().success(
      form.type === 'addSp'
        ? '加入服务商成功'
