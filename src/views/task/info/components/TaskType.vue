<template>
  <div class="flex items-center">
    <el-select :disabled="disabled" placeholder="一级分类" class="w100" v-model="taskTypeFirstValue">
      <el-option :key="item.value" :label="item.label" :value="item.value" v-for="item in task_typeLevel_option.task_typeLevel1_option" />
    </el-select>
    <el-select :disabled="disabled" style="margin-left: 10px" placeholder="二级分类" class="w100" v-model="taskTypeSecondValue">
