			...
			>
				...
				<el-table-column label="是否开启支付通道" width="300">
					<template #default="scope">
						...
						<el-button v-else text type="primary" @click="openDialog(scope.row.id)"> 否，立即前往开通 </el-button>
					</template>
				</el-table-column>
...
import { fetchList, delObjs, switchStatus, spPaymentChannel } from '/@/api/core/spInfo';
