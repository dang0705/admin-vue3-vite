<template>
    ...
    <el-col :span="12" class="mb20">
      <el-form-item label="银行流水号" prop="bankSerialNumber">
        <el-input v-model="form.bankSerialNumber" placeholder="请输入银行流水号"/>
      </el-form-item>
      </el-col>
    ...
    <el-col :span="12" class="mb20">
      <el-form-item label="借贷类型" prop="loanType">
        <el-input v-model="form.loanType" placeholder="请输入借贷类型"/>
      </el-form-item>
      </el-col>
    ...
    <el-col :span="12" class="mb20">
      <el-form-item label="对方账号" prop="reciprocalAccountNumber">
        <el-input v-model="form.reciprocalAccountNumber" placeholder="请输入对方账号"/>
      </el-form-item>
      </el-col>

    <el-col :span="12" class="mb20">
      <el-form-item label="对方户名" prop="reciprocalAccountName">
        <el-input v-model="form.reciprocalAccountName" placeholder="请输入对方户名"/>
      </el-form-item>
      </el-col>

    <el-col :span="12" class="mb20">
      <el-form-item label="对方开户行" prop="reciprocalBank">
        <el-input v-model="form.reciprocalBank" placeholder="请输入对方开户行"/>
      </el-form-item>
      </el-col>

    <el-col :span="12" class="mb20">
      <el-form-item label="附言" prop="dealPostscript">
        <el-input v-model="form.dealPostscript" placeholder="请输入附言"/>
      </el-form-item>
      </el-col>
