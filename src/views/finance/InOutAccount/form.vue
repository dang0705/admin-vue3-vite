			...
			<el-row :gutter="24">
				...
				<el-col :span="12" class="mb20">
					<el-form-item label="退款金额" prop="receiptAmount">
						<InputPlus v-model="form.receiptAmount" placeholder="请输入退款金额" />
					</el-form-item>
				</el-col>

				<el-col :span="12" class="mb20">
					<el-form-item label="收款户名" prop="receiptAccountName">
						<InputPlus v-model="form.receiptAccountName" placeholder="请输入收款户名" />
					</el-form-item>
				</el-col>

				<el-col :span="12" class="mb20">
					<el-form-item label="收款账号" prop="receiptAccountNumber">
						<InputPlus v-model="form.receiptAccountNumber" placeholder="请输入收款账号" />
					</el-form-item>
				</el-col>

				<el-col :span="12" class="mb20">
					<el-form-item label="收款开户行" prop="receiptAccountBank">
						<InputPlus v-model="form.receiptAccountBank" placeholder="请输入收款开户行" />
					</el-form-item>
				</el-col>
