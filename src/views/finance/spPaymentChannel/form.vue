<template>
  <el-dialog :title="title" v-model="visible" :close-on-click-modal="false" draggable width="60%">
    <form-view :disabled="self_disabled" ref="dataFormRef" v-model="form" :forms="conditionForms" :on-submit="onSubmit" :onCancel="() => (visible = false)"
      :submit-button-text="self_disabled ? '关闭' : '确认'" :showCancel="self_disabled ? false : true" :columns="12" vertical :labelWidth="140" button-position="center" />
  </el-dialog>
</template>
...
// import { spPaymentChannel } from '/@/api/core/info';
