<template>
    ...
    <el-col :span="12" class="mb20">
      <el-form-item label="结算单id(settle_bill_record.id)" prop="settleBillRecordId">
        <el-input-number :min="1" :max="1000" v-model="form.settleBillRecordId" placeholder="请输入结算单id(settle_bill_record.id)"></el-input-number>
      </el-form-item>
    </el-col>

    <el-col :span="12" class="mb20">
      <el-form-item label="可开票金额(元)" prop="invoicedAmount">
        <el-input v-model="form.invoicedAmount" placeholder="请输入可开票金额(元)"/>
      </el-form-item>
      </el-col>

    <el-col :span="12" class="mb20">
      <el-form-item label="结算完成时间" prop="settleBillRecordEndTime">
            <el-date-picker type="datetime" placeholder="请选择结算完成时间" v-model="form.settleBillRecordEndTime" :value-format="dateTimeStr"></el-date-picker>
      </el-form-item>
      </el-col>
    ...
    <el-col :span="12" class="mb20">
      <el-form-item label="结算商户名称" prop="merchantName">
        <el-input v-model="form.merchantName" placeholder="请输入结算商户名称"/>
      </el-form-item>
      </el-col>
    ...
    <el-col :span="12" class="mb20">
      <el-form-item label="状态（10:待开票，20:已开票，30:已驳回，40:已作废）" prop="status">
           ...
           <el-radio label="状态（10:待开票，20:已开票，30:已驳回，40:已作废）" border>状态（10:待开票，20:已开票，30:已驳回，40:已作废）</el-radio>
            </el-radio-group>
        </el-form-item>
      </el-col>
    ...
    <el-col :span="12" class="mb20">
      <el-form-item label="作废原因" prop="reason">
        <el-input v-model="form.reason" placeholder="请输入作废原因"/>
      </el-form-item>
      </el-col>
    ...
    <el-col :span="12" class="mb20">
      <el-form-item label="统一社会信用代码" prop="unifiedSocialCreditIdentifier">
        <el-input v-model="form.unifiedSocialCreditIdentifier" placeholder="请输入统一社会信用代码"/>
      </el-form-item>
      </el-col>
    ...
    <el-col :span="12" class="mb20">
      <el-form-item label="开票类目" prop="invoicingCategories">
        <el-input v-model="form.invoicingCategories" placeholder="请输入开票类目"/>
      </el-form-item>
      </el-col>

    <el-col :span="12" class="mb20">
      <el-form-item label="开票金额" prop="invoicingAmount">
        <el-input v-model="form.invoicingAmount" placeholder="请输入开票金额"/>
      </el-form-item>
      </el-col>
    ...
    <el-col :span="12" class="mb20">
      <el-form-item label="发票图片" prop="invoiceFilePath">
        <el-input v-model="form.invoiceFilePath" placeholder="请输入发票图片"/>
      </el-form-item>
      </el-col>

    <el-col :span="12" class="mb20">
      <el-form-item label="邮寄地址" prop="postAddress">
        <el-input v-model="form.postAddress" placeholder="请输入邮寄地址"/>
      </el-form-item>
      </el-col>

    <el-col :span="12" class="mb20">
      <el-form-item label="收件人" prop="postUsername">
        <el-input v-model="form.postUsername" placeholder="请输入收件人"/>
      </el-form-item>
      </el-col>

    <el-col :span="12" class="mb20">
      <el-form-item label="收件人电话" prop="postPhone">
        <el-input v-model="form.postPhone" placeholder="请输入收件人电话"/>
      </el-form-item>
      </el-col>

    <el-col :span="12" class="mb20">
      <el-form-item label="快递公司" prop="postType">
        <el-input v-model="form.postType" placeholder="请输入快递公司"/>
      </el-form-item>
      </el-col>

    <el-col :span="12" class="mb20">
      <el-form-item label="快递单号" prop="postOrderNumber">
        <el-input v-model="form.postOrderNumber" placeholder="请输入快递单号"/>
      </el-form-item>
      </el-col>
