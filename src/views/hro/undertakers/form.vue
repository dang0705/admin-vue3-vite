<template>
	<el-dialog :title="form.id ? '修改承接人' : '添加承接人'" v-model="visible" :close-on-click-modal="false" draggable>
			...
			<el-row :gutter="24">
				...
				<el-col :span="24" class="mb20">
					<el-form-item label="参加工作日期:" prop="workTime">
						<el-date-picker type="date" placeholder="请选择参加工作日期" v-model="form.workTime" :value-format="dateStr"></el-date-picker>
					</el-form-item>
				</el-col>
