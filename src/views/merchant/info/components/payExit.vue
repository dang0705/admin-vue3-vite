<template>
  ...
  <el-table
    ...
    <el-table-column
      prop="subAccountNum"
      min-width="100"
      :label="$t('merchantInfo.subAccount')"
      show-overflow-tooltip />
    <el-table-column
      prop="mainAccount"
      min-width="140"
      :label="$t('merchantInfo.mainAccount')"
      show-overflow-tooltip />
    <el-table-column
      prop="spName"
      :label="$t('merchantInfo.spList')"
      show-overflow-tooltip />
    <el-table-column
      prop="channelName"
      :label="$t('merchantInfo.payExit')"
      show-overflow-tooltip />
    <el-table-column
    ...
    <el-table-column label="操作" width="300" fixed="right">
      <template #default="scope">
        <el-button
          icon="view"
          v-auth="'core_payExit_view'"
          @click="payExitDetailDialogRef.openDialog(scope.row.id)"
          text
          type="primary">
          查看
        </el-button>
...
import {
  getMerchantSubAccountList,
  getSpPaymentChannelList,
  putMerchantSubAccount
} from '/@/api/core/merchantInfo'
...
const PayExitDetailDialog = defineAsyncComponent(
  () => import('./payExitDetailDialog.vue')
)
