...
import { baseRoutes, notFoundAndNoPower } from '@jmyg/router/route'
 ...
 * @link 参考：https://next.router.vuejs.org/zh/api/#addroute
 * @param chil baseRoutes（@jmyg/router/route）第一个顶级 children 的下路由集合
...
export function setFilterMenuAndCacheTagsViewRoutes() {
  ...
  storesRoutesList.setRoutesList(
    setFilterHasRolesMenu(baseRoutes[0].children, userInfos.value.roles)
  )
