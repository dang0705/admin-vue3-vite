...
import { getObj } from '@jmyg/api/core/settleBill'
...
import total1 from '@/assets/images/total_1.png'
import total3 from '@/assets/images/total_3.png'
import total4 from '@/assets/images/total_4.png'
import total6 from '@/assets/images/total_6.png'
...
const SettleBillTaskRecordItem = defineAsyncComponent(
  () => import('@jmyg/views/accounting/settleBillTaskRecordItem/index.vue')
)
