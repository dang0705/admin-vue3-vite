  ...
  <div class="h-[100vh] overflow-scroll bg-[#fff]">
    ...
    <p
      ...
      <span
        style="
          ...
          mso-font-kerning: 0pt;
        ">
        <span style="font-family: 宋体">本协议更新日期</span>
        <span style="font-family: 宋体">2023年</span>
      </span>
      <span
        style="
          mso-spacerun: 'yes';
    ...
    <p
      ...
      <span
        style="
          ...
          mso-font-kerning: 0pt;
        ">
        <span style="font-family: 宋体">本协议生效日期</span>
        <span style="font-family: 宋体">2023年</span>
      </span>
      <span
        style="
    ...
    <p
      ...
      <span
        ...
        <span style="font-family: 宋体">&ldquo;极目人才&rdquo;</span>
      </span>
      <span
        style="
          mso-spacerun: 'yes';
    ...
    <p
      ...
      ">
      <!-- [if !supportLists]-->
      <span style="font-family: 宋体; font-size: 10.5pt; mso-font-kerning: 0pt">
        ①　
      </span>
      <!--[endif]-->
      <span
      ...
      <strong>
        <span
          style="
            ...
            background-clip: initial;
          ">
          特别是其中所涉及的免除、减轻我们责任的条款、对您权利限制条款、争议解决和法律适用等。
        </span>
      </strong>
      <strong>
        <span
          ...
          style="
            ...
            background-clip: initial;
          ">
          其中，限制、免责条款、与您的权益（可能）存在重大关系的条款，已采用加粗字的形式提示您重点注意。
        </span>
      </strong>
      <span
        style="
          ...
          background-clip: initial;
        ">
        请您审慎阅读并选择接受或不接受本协议。除非您已阅读并接受本协议所有条款，否则您无权使用本服务。如您不同意本协议，或本协议全部或任何部分的修改，请您停止访问或使用本服务。
      </span>
    </p>
    <p
      class="p"
    ...
    <p
      ...
      <!--[endif]-->
      <span style="font-family: 宋体; letter-spacing: 0pt; font-size: 10.5pt">
        用于维护我们产品或服务的安全稳定运行所必需的，例如发现、处置产品或服务故障；
      </span>
    </p>
    <p
      class="p"
    ...
    <p
      ...
      <strong>
        <span style="font-family: 宋体; letter-spacing: 0pt; font-size: 10.5pt">
          我们仅按照相关法律法规的规定承担平台责任，我们不对第三方的诽谤、犯罪或其他非法行为承担责任，也不赔偿因此造成的您的损失，但因我们对您遭受的损失负有法定过错的除外。
        </span>
      </strong>
    </p>
    <p
