...
import { getObj } from '@jmyg/api/core/batchUploadRecord'
import { State } from '@jmyg/views/batch/import/configurations/enums'
import columns from '@jmyg/views/batch/import/configurations/columns'
import conditionForms from '@jmyg/views/batch/import/configurations/condition-forms'
import dynamicForms from '@jmyg/views/batch/import/configurations/dynamic-forms'
