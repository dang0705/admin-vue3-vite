<template>
  <Dialog
    ...
    :showBtn="showBtn">
    <template #workload>
      <InputPlus disabled :modelValue="formData.workload" />
...
import { getObj, putTaskAcceptance } from '@jmyg/api/core/undertakerTask'
import { rule } from '@utils/validate'
import uploadBusinessType from '@enums/upload-business-type'
import dynamicForms from '@jmyg/views/task/undertaker/components/dynamic-forms'
defineOptions({ name: 'UndertakerInfoDialog' })
// import dynamicForms from '@jmyg/views/batch/import/dynamic-forms';
