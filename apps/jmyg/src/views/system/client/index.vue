      ...
      <el-row class="ml10" v-show="showSearch">
        <el-form
          ...
          <el-form-item>
            ...
            <el-button v-debounce="resetQuery" icon="Refresh">
              {{ $t('common.resetBtn') }}
            </el-button>
          </el-form-item>
        </el-form>
      ...
      <el-table
        ...
        <el-table-column
          ...
          <template #default="scope">
            <dict-tag
              :options="grant_types"
              :value="scope.row.authorizedGrantTypes" />
          </template>
        </el-table-column>
        <el-table-column
...
import { delObj, fetchList, refreshCache } from '@jmyg/api/admin/client'
import { useMessage, useMessageBox } from '@hooks/message'
import { useDict } from '@hooks/dict'
import { useI18n } from 'vue-i18n'
defineOptions({ name: 'systemSysOauthClientDetails' })
// 引入组件
