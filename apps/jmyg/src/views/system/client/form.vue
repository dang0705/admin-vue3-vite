  ...
  <el-dialog
    ...
    <el-form
      ...
      <el-form-item :label="t('client.clientSecret')" prop="clientSecret">
        <el-input
          :placeholder="t('client.inputClientSecretTip')"
          v-model="form.clientSecret" />
      </el-form-item>
      <el-form-item :label="t('client.scope')" prop="scope">
        <el-input
          :placeholder="t('client.inputScopeTip')"
          v-model="form.scope" />
      </el-form-item>
      <el-form-item
      ...
      <el-form-item
        ...
        <el-radio-group v-model="form.autoapprove">
          <el-radio
            ...
            :label="item.value"
            border
            v-for="(item, index) in common_status">
            {{ item.label }}
          </el-radio>
        </el-radio-group>
      </el-form-item>
      <el-form-item
        ...
        v-if="form.authorizedGrantTypes.includes('authorization_code')">
        <el-input
          :placeholder="t('client.inputAuthoritiesTip')"
      ...
      <el-form-item
        ...
        v-if="form.authorizedGrantTypes.includes('authorization_code')">
        <el-input
          :placeholder="t('client.inputWebServerRedirectUriTip')"
...
const dataRules = ref({
  clientId: [
    ...
    { validator: rule.lowercase, trigger: 'blur' },
    {
  ...
  clientSecret: [
    ...
    { validator: rule.lowercaseOnly, trigger: 'blur' }
  ],
