  ...
  <el-dialog
    ...
    <div class="layout-padding-auto layout-padding-view">
      ...
      <el-table
        ...
        <el-table-column
          prop="jobMessage"
          :label="t('log.jobMessage')"
          show-overflow-tooltip />
        <el-table-column
          prop="jobLogStatus"
          :label="t('log.jobLogStatus')"
          show-overflow-tooltip>
          <template #default="scope">
            <dict-tag
              :options="job_execute_status"
              :value="scope.row.jobLogStatus"></dict-tag>
          </template>
        </el-table-column>
        <el-table-column
          prop="executeTime"
          :label="t('log.executeTime')"
          show-overflow-tooltip />
        <el-table-column
          prop="exceptionInfo"
          :label="t('log.exceptionInfo')"
          show-overflow-tooltip />
        <el-table-column
          prop="createTime"
...
import { fetchList, delObjs } from '@jmyg/api/daemon/job-log'
