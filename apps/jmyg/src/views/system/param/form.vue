  ...
  <el-dialog
    ...
    <el-form
      ...
      <el-form-item :label="t('param.publicType')" prop="publicType">
        <el-select
          :placeholder="t('param.inputpublicTypeTip')"
      ...
      <el-form-item :label="t('param.validateCode')" prop="validateCode">
        <el-input
          :placeholder="t('param.inputvalidateCodeTip')"
      ...
      <el-form-item :label="t('param.publicValue')" prop="publicValue">
        <el-input
          :placeholder="t('param.inputpublicValueTip')"
...
const dataRules = reactive({
  ...
  publicKey: [
    ...
    { validator: rule.capital, trigger: 'blur' },
    {
      validator: (rule: any, value: any, callback: any) => {
...
const onSubmit = async () => {
  ...
  try {
    ...
    useMessage().success(
      t(form.publicId ? 'common.editSuccessText' : 'common.addSuccessText')
    )
    visible.value = false
    emit('refresh')
  } catch (err: any) {
