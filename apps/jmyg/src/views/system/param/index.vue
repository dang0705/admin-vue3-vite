    ...
    <div class="layout-padding-auto layout-padding-view">
      <el-row class="ml10" v-show="showSearch">
        <el-form :inline="true" :model="state.queryForm" ref="queryRef">
          ...
          <el-form-item
            :label="t('param.systemFlag')"
            class="ml2"
            prop="systemFlag">
            <el-select
              :placeholder="t('param.inputsystemFlagTip')"
              v-model="state.queryForm.systemFlag">
              <el-option
                :key="index"
                :label="item.label"
                :value="item.value"
      ...
      <el-table
        ...
        <el-table-column
          :label="t('param.publicName')"
          prop="publicName"
          show-overflow-tooltip />
        <el-table-column
          :label="t('param.publicKey')"
          prop="publicKey"
          show-overflow-tooltip />
        <el-table-column
          :label="t('param.publicValue')"
          prop="publicValue"
          show-overflow-tooltip />
        <el-table-column
          :label="t('param.status')"
          prop="status"
          show-overflow-tooltip>
        ...
        <el-table-column
          ...
          <template #default="scope">
            <dict-tag
              :options="dict_type"
              :value="scope.row.systemFlag"></dict-tag>
          </template>
        </el-table-column>
...
import { delObj, fetchList, refreshCache } from '@jmyg/api/admin/param'
import { useMessage, useMessageBox } from '@hooks/message'
import { useDict } from '@hooks/dict'
import { useI18n } from 'vue-i18n'

defineOptions({ name: 'systemSysPublicParam' })
// 引入组件
