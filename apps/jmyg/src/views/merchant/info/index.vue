...
import conditionForms from '@jmyg/views/merchant/info/configurations/condition-forms'
import columns from '@jmyg/views/merchant/info/configurations/columns'
import actions from '@jmyg/views/merchant/info/configurations/actions'
