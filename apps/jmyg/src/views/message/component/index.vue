...
import bgc from '@configurations/message-tag-definition'
import { deleteObj, readMark, readUnread } from '@jmyg/api/docs/message'
import qs from 'qs'
import noMessage from '@/assets/images/home-message-no-data.webp'
defineProps({
  hasMore: {
    type: Boolean,
    default: false
