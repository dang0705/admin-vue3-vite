    ...
    <el-form
      ...
      <el-form-item :label="t('fieldtype.attrType')" prop="attrType">
        <el-input
          ...
          :placeholder="t('fieldtype.inputattrTypeTip')" />
      </el-form-item>
      <el-form-item :label="t('fieldtype.packageName')" prop="packageName">
        <el-input
          v-model="form.packageName"
          :placeholder="t('fieldtype.inputpackageNameTip')" />
      </el-form-item>
    </el-form>
    <template #footer>
...
import {
  ...
  putObj,
  validateColumnType
} from '@jmyg/api/gen/fieldtype'
import { useI18n } from 'vue-i18n'
defineOptions({ name: 'systemFieldTypeDialog' })
// 定义子组件向父组件传值/事件
