        ...
        <el-main>
          <el-row>
            ...
            <el-form-item :label="t('template.desc')" prop="templateDesc">
              <el-input
                :placeholder="t('template.inputDescTip')"
                v-model="form.templateDesc" />
            </el-form-item>
            <el-form-item
              :label="t('template.generatorPath')"
              prop="generatorPath">
              <el-input
                :placeholder="t('template.inputGeneratorPathTip')"
...
import { addObj, getObj, putObj } from '@jmyg/api/gen/template'
import { useI18n } from 'vue-i18n'

defineOptions({ name: 'GenTemplateDialog' })
