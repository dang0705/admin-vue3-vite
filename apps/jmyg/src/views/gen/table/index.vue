          ...
          <el-form-item label="数据源" prop="name">
            <el-select
              ...
              <el-option
                ...
                :label="ds.name"
                :value="ds.name"
                v-for="ds in datasourceList"></el-option>
            </el-select>
          </el-form-item>
...
import { fetchList, useSyncTableApi, useTableApi } from '@jmyg/api/gen/table'
import { list } from '@jmyg/api/gen/datasource'
