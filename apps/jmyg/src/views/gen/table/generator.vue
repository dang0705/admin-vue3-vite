    ...
    <el-row>
      ...
      <el-col :span="12" class="mb20">
        <el-form-item label="说明" prop="tableComment">
          <el-input
            placeholder="说明"
            v-model="dataForm.tableComment"></el-input>
        </el-form-item>
      </el-col>
    </el-row>
    <el-row>
    ...
    <el-row>
      <el-col :span="12" class="mb20">
        <el-form-item label="项目包名" prop="packageName">
          <el-input
            placeholder="项目包名"
            v-model="dataForm.packageName"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12" class="mb20">
        <el-form-item label="模块名" prop="moduleName">
          <el-input
            placeholder="模块名"
            v-model="dataForm.moduleName"></el-input>
        </el-form-item>
      </el-col>
    </el-row>
    <el-row>
      <el-col :span="12" class="mb20">
        <el-form-item label="功能名" prop="functionName">
          <el-input
            placeholder="功能名"
            v-model="dataForm.functionName"></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12" class="mb20">
    ...
    <el-row>
      ...
      <el-col :span="24" class="mb20">
        <el-form-item
          ...
          <el-input
            placeholder="后端生成路径"
            v-model="dataForm.backendPath"></el-input>
        </el-form-item>
        <el-form-item
          label="前端生成路径"
          prop="frontendPath"
          ...
          <el-input
            placeholder="前端生成路径"
            v-model="dataForm.frontendPath"></el-input>
        </el-form-item>
      </el-col>
    </el-row>
  </el-form>
...
import { putObj, useTableApi } from '@jmyg/api/gen/table'
import { list as groupList } from '@jmyg/api/gen/group'
