  ...
  <div class="layout-padding">
    <div class="layout-padding-auto layout-padding-view">
      ...
      <el-table
        ...
        <el-table-column
          :label="t('datasourceconf.index')"
          type="index"
          width="60" />
        <el-table-column
          :label="t('datasourceconf.name')"
          prop="name"
          show-overflow-tooltip />
        <el-table-column
          :label="t('datasourceconf.dsName')"
          prop="dsName"
          show-overflow-tooltip />
        <el-table-column
          :label="t('datasourceconf.dsType')"
          prop="dsType"
          show-overflow-tooltip />
        <el-table-column
          :label="t('datasourceconf.username')"
          prop="username"
          show-overflow-tooltip />
        <el-table-column
        ...
        <el-table-column :label="$t('common.action')" width="250">
          <template #default="scope">
            <el-button
              icon="document"
              @click="downloadDoc(scope.row.name)"
              text
              type="primary">
...
import { delObj, fetchList } from '@jmyg/api/gen/datasource'
