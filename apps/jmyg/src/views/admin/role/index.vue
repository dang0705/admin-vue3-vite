  ...
  <div class="layout-padding">
    <div class="layout-padding-auto layout-padding-view">
      ...
      <el-table
        ...
        <el-table-column
          prop="assignedUsers"
          :label="$t('sysrole.assignedUsers')"
          show-overflow-tooltip />
        <el-table-column
          prop="enabledStr"
          :label="$t('sysrole.status')"
          show-overflow-tooltip>
        ...
        <el-table-column fixed="right" :label="$t('common.action')" width="300">
          <template #default="scope">
            ...
            <el-button
              ...
              type="primary"
              icon="Switch"
              @click="distributionRef.openDialog(scope.row)">
              {{ $t('common.distribution') }}
            </el-button>
            <el-button
              v-auth="`sys_role_switch`"
              icon="turn-off"
              text
              type="primary"
    ...
    <Distribution
      ...
      ref="distributionRef"
      type="10"
      list-url="/admin/user/assignRolesPage"
      save-url="/admin/user/assignRoles" />
  </div>
</template>

<script setup lang="ts">
import { BasicTableProps, useTable } from '@hooks/table'
import { delObj, pageList, putObj } from '@jmyg/api/admin/role'
