    ...
    <el-form
      ...
      <el-form-item :label="t('post.postCode') + '：'" prop="postCode">
        <el-input
          ...
          :placeholder="t('post.inputpostCodeTip')" />
      </el-form-item>
      ...
      <el-form-item :label="t('post.postSort') + '：'" prop="postSort">
        <el-input-number
          ...
          :placeholder="t('post.inputpostSortTip')" />
      </el-form-item>
...
const onSubmit = async () => {
  ...
  try {
    ...
    useMessage().success(
      t(form.postId ? 'common.editSuccessText' : 'common.addSuccessText')
    )
    visible.value = false
    emit('refresh')
  } catch (err: any) {
