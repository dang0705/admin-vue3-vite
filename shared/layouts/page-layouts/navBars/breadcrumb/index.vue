...
import spInfo from '@jmyg/api/core/spInfo'
import mittBus from '@utils/mitt'
import baseUrl from '@configurations/base-url'

// 引入组件
const Breadcrumb = defineAsyncComponent(
  () => import('@layouts/page-layouts/navBars/breadcrumb/breadcrumb.vue')
)
const User = defineAsyncComponent(
  () => import('@layouts/page-layouts/navBars/breadcrumb/user.vue')
)
const Logo = defineAsyncComponent(() => import('@layouts/logo/index.vue'))
const Horizontal = defineAsyncComponent(
  () => import('@layouts/page-layouts/navMenu/horizontal.vue')
)
