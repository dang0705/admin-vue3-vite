<template>
  <div
    class="layout-navbars-breadcrumb-user pr15 items-center"
...
const UserNews = defineAsyncComponent(
  () => import('@layouts/page-layouts/navBars/breadcrumb/userNews.vue')
)
const Search = defineAsyncComponent(
  () => import('@layouts/page-layouts/navBars/breadcrumb/search.vue')
)
const PersonalDrawer = defineAsyncComponent(
  () => import('@jmyg/views/admin/user/personal.vue')
)
const ChangePassword = defineAsyncComponent(
  () => import('@jmyg/views/admin/user/setPassword.vue')
)
...
// 是否开启websocket
const websocketEnable = ref(env.VITE_WEBSOCKET_ENABLE === 'true')
