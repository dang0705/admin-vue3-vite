    ...
    <el-drawer
      ...
      <el-scrollbar class="layout-breadcrumb-seting-bar">
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt15">
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-select
              ...
              <el-option
                :label="$t('user.dropdownLarge')"
                value="large"></el-option>
              <el-option
                :label="$t('user.dropdownDefault')"
                value="default"></el-option>
              <el-option
                :label="$t('user.dropdownSmall')"
        ...
        <div
          class="layout-breadcrumb-seting-bar-flex"
          :style="{
            opacity: getThemeConfig.layout === 'transverse' ? 0.5 : 1
          }">
          <div class="layout-breadcrumb-seting-bar-flex-label">
